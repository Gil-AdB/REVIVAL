...
## 00q. greets' PASSENGER ROWS — 2026-08-29c: `RTT` ran its 96 lighting tiles **inline on the tick thread**; pooling them is **−24.1 %** byte-null. The other three rows are healthy, and `Tick-ReflXfrm`'s attribution is corrected **30×**
