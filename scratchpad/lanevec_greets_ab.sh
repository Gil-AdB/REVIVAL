#!/bin/zsh
# Interleaved A/B of --vol_cone_lane_vec on GREETS (narrow disco-beam cones,
...
runarm() {
  local flag=--no-vol_cone_lane_vec
  [[ $2 == VEC ]] && flag=--vol_cone_lane_vec
...
print -r -- "# greets cone LANE-vec A/B  iters=$ITERS rounds=$ROUNDS"
