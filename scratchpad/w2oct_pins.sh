#!/bin/zsh
# Pin gate for the lighting-w2 campaign. Canonical recipes, in THIS worktree's
# Runtime/ (DEMO chdirs to its own directory). Nine pins:
#   greets t=1588, fountain t=2500, city t=1961 (x2 arms), chase t=100..1600 (5).
#   usage: w2_pins.sh /path/to/DEMO tag [runs]
set -u
WT=/Users/gil-ad/work/rev-w2oct
BIN=$1; TAG=$2; RUNS=${3:-2}
OUT=${PIN_OUT:-/tmp/w2oct/pins}/$TAG
mkdir -p $OUT
